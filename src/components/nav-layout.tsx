          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="ml-4 flex items-center md:ml-6">
              <div className="ml-3 relative">
                <div>
                  <button
                    className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white text-white"
                    id="user-menu"
                    aria-haspopup="true"
                    ...
                    {user.currentUser?.photoURL && (
                      <img className="ml-2 h-8 w-8 rounded-full" src={user.currentUser.photoURL} alt="User Avatar" />
                    )}
                  </button>
                </div>
